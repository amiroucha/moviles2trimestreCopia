...
List<MonitorFragment>): RecyclerView.Adapter<MonitorAdapter.MonitorViewHolder>() {
    ...
    {
        fun bind(data : MonitorFragment){ //esta funcion se llama por cada item de monitorAdapter
