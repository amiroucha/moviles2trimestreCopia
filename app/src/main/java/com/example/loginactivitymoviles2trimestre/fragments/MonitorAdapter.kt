...
import com.example.loginactivity.databinding.LayoutItemBinding
//Adapter para recyclerView

class MonitorAdapter(private val items:
List<Monitor>): RecyclerView.Adapter<MonitorAdapter.MonitorViewHolder>() {
    ...
    class MonitorViewHolder(private val binding: LayoutItemBinding) : RecyclerView.ViewHolder(binding.root)
    {
